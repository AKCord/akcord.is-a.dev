...
import LiteClash from "../../assets/LiteClash.webp";
import {
  SiReact,
  SiExpress,
  SiMongodb,
...
export function DiscordJS(props) {
  return (
...
const projectsData = [
  {
    title: "Malinka Games",
    description:
      "A full-fledged website made using React & Tailwind CSS, crafted with love and uniquely.",
    techStack: [
    ...
    status: "Live",
    link: "https://www.malinkagames.com/",
    logo: "https://www.malinkagames.com/assets/IconSVG-DtQFGf1L.svg",
    screenshot: null,
  },
  {
  ...
  },
  {
    title: "LiteClash",
    description:
      "The main project consisting of the discord bot & the API coded entirely by me.",
    techStack: [
